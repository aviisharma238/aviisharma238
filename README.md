...
![My Skills](https://skillicons.dev/icons?i=blender,html,css,js,ts,nextjs,react,tailwind,figma,notion,npm,pnpm,git,github,nodejs,mongodb,mysql,jest,postman,vscode,vercel,vite,bash,linux,md,cloudflare,java,c,py,docker)
